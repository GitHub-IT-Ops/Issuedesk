...
var Gitzen = /** @class */ (function () {
    ...
    Gitzen.prototype.getIssueThread = function () {
        return __awaiter(this, void 0, void 0, function () {
            var owner, repo, IssueNumber, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.octokit.issues.listComments({ owner: owner, repo: repo, IssueNumber: IssueNumber })];
                    case 1:
                        data = _a.sent();
