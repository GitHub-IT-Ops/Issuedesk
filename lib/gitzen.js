...
var Gitzen = /** @class */ (function () {
    ...
    Gitzen.prototype.doesTicketAlreadyExist = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.tickets.list(function (err, statusList, body, responseList, resultList) {
                            if (err) {
                                console.log(err);
                                return;
                            }
                    ...
                    case 1:
                        zenDeskTickets = _a.sent();
                        console.log(zenDeskTickets);
                        return [2 /*return*/, zenDeskTickets
    ...
    Gitzen.prototype.formatListComments = function (listOfComments) {
        return __awaiter(this, void 0, void 0, function () {
            var issueThread, i, commenter, createdAt, updatedAt, comment;
            return __generator(this, function (_a) {
                switch (_a.label) {
