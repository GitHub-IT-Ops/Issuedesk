...
var Gitzen = /** @class */ (function () {
    ...
    Gitzen.prototype.setExternalId = function (externalId) {
    ...
    Gitzen.prototype.getTicketList = function (doesTicketAlreadyExist) {
        var _this = this;
    ...
    Gitzen.prototype.getIssueId = function () {
        return this.context.payload.label;
    };
    ...
    Gitzen.prototype.ticketCreation = function (ticketExists) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Gitzen.prototype.doesTicketAlreadyExist = function (body) {
