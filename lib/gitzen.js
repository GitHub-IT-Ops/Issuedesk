...
var Gitzen = /** @class */ (function () {
    ...
    Gitzen.prototype.contructor = function (zendeskUsername, zendeskToken, zendeskURI, myToken) {
    ...
    Gitzen.prototype.logcontext = function () {
    ...
    Gitzen.prototype.getIssueThread = function (owner, repo, issue_number) {
        return __awaiter(this, void 0, void 0, function () {
            var commentThread;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.octokit.issues.listComments({
                            owner: owner,
                            repo: repo,
                            issue_number: issue_number,
                        })];
                    case 1:
                        commentThread = _a.sent();
