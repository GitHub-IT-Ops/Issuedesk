...
var IssueMonitor = /** @class */ (function () {
    ...
    IssueMonitor.prototype.getIssueLabels = function () {
        return this.context.payload.issue.labels;
    };
    // specifically for use in issue comment events
    IssueMonitor.prototype.getIssueComment = function () {
        return this.context.payload.comment.body;
    };
    // specifically for use in issue comment events
    IssueMonitor.prototype.getCommentCreatedAtTime = function () {
        return this.context.payload.comment.created_at;
    };
    IssueMonitor.prototype.getCommentAuthor = function () {
