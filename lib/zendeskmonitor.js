...
var ZendeskMonitor = /** @class */ (function () {
    ...
    ZendeskMonitor.prototype.getAllZendeskTickets = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.tickets.list(function (err, statusList, tickets) {
    ...
    ZendeskMonitor.prototype.createTicketIfItDoesNotExist = function (ticket) {
        return __awaiter(this, void 0, void 0, function () {
            var existingTickets, i, ticketExists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAllZendeskTickets()];
                    case 1:
                        existingTickets = _a.sent();
                        for (i = 0; i < existingTickets.length; i++) {
                            ticketExists = this.doesTicketAlreadyExist(existingTickets[i], ticket);
                            if (ticketExists) {
