...
var ZendeskMonitor = /** @class */ (function () {
    ...
    ZendeskMonitor.prototype.getAllTicketsWithExternalId = function (
        external_id
    ) {
    ...
    ZendeskMonitor.prototype.doesTicketAlreadyExist = function (
        existingTicket,
        newTicket
    ) {
        if (
                    ...
                    case 0:
                        return [
                            ...
                            new Promise(function (resolve) {
                                _this.client.tickets.list(function (
                                    err,
                                    statusList,
                                    body
                                ) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (i = 0; i < allZendeskTickets.length; i++) {
                            ticketExists = this.doesTicketAlreadyExist(
                                allZendeskTickets[i],
                                ticket
                            )
                            if (ticketExists) {
    ...
    ZendeskMonitor.prototype.closeTicket = function (external_id) {
        this.client.update(ticketID, ticket, function (body) {
            console.log()
        })
    }
