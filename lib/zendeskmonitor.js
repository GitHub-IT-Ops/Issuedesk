...
var ZendeskMonitor = /** @class */ (function () {
    ...
    ZendeskMonitor.prototype.getAllTicketsWithExternalId = function (external_id) {
        return __awaiter(this, void 0, void 0, function () {
            var allTickets, allTicketsWithExternalId, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAllZendeskTickets()];
                    case 1:
                        allTickets = _a.sent();
                        allTicketsWithExternalId = [];
                        for (i = 0; i < allTickets.length; i++) {
                            if (allTickets[i]['external_id'] === external_id) {
                                allTicketsWithExternalId.push(allTickets[i]);
                            }
                        }
                        return [2 /*return*/, allTicketsWithExternalId];
                }
            });
        });
    };
    ...
    ZendeskMonitor.prototype.doesTicketAlreadyExist = function (existingTicket, newTicket) {
        var ticketIsOpen = this.isTicketOpen(existingTicket['status']);
    ...
    ZendeskMonitor.prototype.updateTicketWithIssueComment = function (ticket) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!ticketExists) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.client.tickets.update(allZendeskTickets[i]['id'], ticket)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
