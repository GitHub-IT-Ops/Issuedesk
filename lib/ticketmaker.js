...
var Ticketmaker = /** @class */ (function () {
    ...
    Ticketmaker.prototype.createIfTicketDoesntExist = function (doesTicketAlreadyExist) {
    ...
    Ticketmaker.prototype.ticketCreation = function (ticketExists, issueUrl, issueTitle, listOfComments) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.generateTicket(issueUrl, issueTitle, listOfComments)];
                    case 2:
                        _a.sent();
                        this.createTicket();
                        _a.label = 3;
    ...
    Ticketmaker.prototype.createTicketIfItDoesNotExist = function (body, ticketExists, issueUrl, issueTitle, listOfComments) {
