...
var Ticketmaker = /** @class */ (function () {
    ...
    Ticketmaker.prototype.createIfTicketDoesntExist = function (
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            this.generateTicketBody(listOfComments, issueUrl),
                        ]
                    case 1:
                        _a.sent()
                        return [2 /*return*/]
    ...
    Ticketmaker.prototype.ticketCreation = function (
        ticketExists,
        issueUrl,
        issueTitle,
        listOfComments
    ...
    Ticketmaker.prototype.createTicketIfItDoesNotExist = function (
        body,
        ticketExists,
        issueUrl,
        issueTitle,
