...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.monitorIssueAndMakeTicket = function () {
        return __awaiter(this, void 0, void 0, function () {
            var issueMonitor, ticketMaker, listOfComments, issueUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new IssueMonitor(this.octokit, this.context)];
                    case 1:
                        issueMonitor = _a.sent();
                        return [4 /*yield*/, new TicketMaker(this.client)];
                    case 2:
                        ticketMaker = _a.sent();
                        return [4 /*yield*/, issueMonitor.getListOfComments()];
                    case 3:
                        listOfComments = _a.sent();
                        return [4 /*yield*/, issueMonitor.getIssueUrl()];
                    case 4:
                        issueUrl = _a.sent();
                        return [4 /*yield*/, ticketMaker.generateTicketBody(listOfComments, issueUrl)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, ticketMaker.createTicketIfItDoesNotExist()];
                    case 6:
                        _a.sent();
                        return [2 /*return*/];
                }
