...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.monitorIssueAndMakeTicket = function (activationLabel) {
        return __awaiter(this, void 0, void 0, function () {
            var labelName, listOfComments, issueUrl, issueTitle, issueBody, issueAuthor, timeIssueCreatedAt, ticket;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.ticketMaker.generateTicketBody(issueBody, issueAuthor, timeIssueCreatedAt, listOfComments, issueUrl);
                        return [4 /*yield*/, this.ticketMaker.getTicket()];
                    case 2:
                        ticket = _a.sent();
                        return [4 /*yield*/, this.zendeskMonitor.createTicketIfItDoesNotExist(ticket)];
                    case 3:
                        _a.sent();
    ...
    IssueDesk.prototype.updateTicket = function (activationLabel) {
        return __awaiter(this, void 0, void 0, function () {
            var labeData, i, labelName;
            return __generator(this, function (_a) {
                labeData = this.issueMonitor.getIssueLabels();
                for (i = 0; i < labeData.length; i++) {
                    labelName = labeData[i]['name'];
                    if (activationLabel === labelName) {
                        this.ticketMaker;
