...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.doesIssueLabelMatchActivationLabel = function (
        activationLabel,
        labelName
    ) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            this.issueMonitor.getListOfComments(),
                        ]
                    case 1:
                    ...
                    case 2:
                        ...
                        return [
                            4 /*yield*/,
                            this.zendeskMonitor.createTicketIfItDoesNotExist(
                                ticket
                            ),
                        ]
                    case 3:
                    ...
                    case 4:
                        console.log(
                            labelName +
                                ' is not an activation label. Ticket will not be created'
                        )
