...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.monitorIssueAndMakeTicket = function (activationLabels) {
        return __awaiter(this, void 0, void 0, function () {
            var issueMonitor, labelData, i, ticketMaker, listOfComments, issueUrl, issueTitle, ticketSubject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        issueMonitor = new IssueMonitor(this.octokit, this.context);
                        labelData = issueMonitor.getLabelEventData();
                        i = 0;
                        _a.label = 1;
                    case 1:
                        if (!(i > activationLabels.length)) return [3 /*break*/, 6];
                        if (!(activationLabels[i] === labelData)) return [3 /*break*/, 4];
                        ticketMaker = new TicketMaker(this.client);
                    ...
                    case 2:
                        ...
                        ticketSubject = issueMonitor.getIssueTitle();
                        ticketMaker.generateTicketSubject(ticketSubject);
                        return [4 /*yield*/, ticketMaker.createTicketIfItDoesNotExist(issueUrl, issueTitle, listOfComments)];
                    case 3:
                        _a.sent();
