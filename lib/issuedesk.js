...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.monitorIssueAndMakeTicket = function (activationLabel) {
        return __awaiter(this, void 0, void 0, function () {
            var issueMonitor, labelName, ticketMaker, listOfComments, issueUrl, issueTitle, issueBody, issueAuthor, timeIssueCreatedAt, ticket, zendeskMonitor;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        ticket = ticketMaker.getTicket();
                        zendeskMonitor = new ZendeskMonitor(this.client);
                        return [4 /*yield*/, zendeskMonitor.createTicketIfItDoesNotExist(ticket)];
                    case 2:
                        _a.sent();
