...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.monitorIssueAndMakeTicket = function () {
        return __awaiter(this, void 0, void 0, function () {
            var issueMonitor, ticketMaker, listOfComments, issueUrl, issueTitle;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ticketMaker.createTicketIfItDoesNotExist(issueTitle, issueUrl, listOfComments)];
                    case 2:
                        _a.sent();
