...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.getIssueAction = function () {
        var actionMonitor = new IssueMonitor(this.octokit, this.context)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [
                            4 /*yield*/,
                            zendeskMonitor.createTicketIfItDoesNotExist(ticket),
                        ]
                    case 3:
                        _a.sent()
    ...
    IssueDesk.prototype.closeTicket = function () {
        var zendeskMonitor = new ZendeskMonitor(this.client)
