...
var IssueDesk = /** @class */ (function () {
    ...
    IssueDesk.prototype.monitorIssueAndMakeTicket = function (activationLabel) {
        return __awaiter(this, void 0, void 0, function () {
            var issueMonitor, labelData, ticketMaker, listOfComments, issueUrl, issueTitle, ticketSubject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        issueMonitor = new IssueMonitor(this.octokit, this.context);
                        labelData = issueMonitor.getLabelEventData();
                        if (!(activationLabel === labelData)) return [3 /*break*/, 3];
                    ...
                    case 3:
                        console.log(labelData + " is not an activation label. Ticket will not be created");
